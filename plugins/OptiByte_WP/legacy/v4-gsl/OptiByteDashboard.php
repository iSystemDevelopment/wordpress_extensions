...
require_once __DIR__ . '/OptiByteLog.php';
require_once __DIR__ . '/OptiByteUIHelper.php';

class OptiByteDashboard {
    public static function handleActions($token) {
    ...
    public static function renderUI($token) {
